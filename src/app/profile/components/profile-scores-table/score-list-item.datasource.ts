 ...
 */
export class ScoreListItemDataSource extends DataSource<any> {
  data: ScoreListItem[];
  paginator: MatPaginator | undefined;
  sort: MatSort | undefined;

  constructor(inputData: ScoreListItem[]) {
    super();
    this.data = inputData;
  }
   ...
   */
  private getPagedData(data: ScoreListItem[]): ScoreListItem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: ScoreListItem[]): ScoreListItem[] {
