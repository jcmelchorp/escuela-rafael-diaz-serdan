...
export class BreadcrumbComponent implements OnInit {
   ...
   * @param breadcrumbs
   */
  buildBreadCrumb(route: ActivatedRoute, url: string | undefined = '', breadcrumbs: IBreadCrumb[] = []): IBreadCrumb[] {
    ...
    if (isDynamicRoute && !!route.snapshot) {
      ...
      path = path ? path.replace(lastRoutePart ? lastRoutePart : '', route.snapshot.params[paramName]) : '';
