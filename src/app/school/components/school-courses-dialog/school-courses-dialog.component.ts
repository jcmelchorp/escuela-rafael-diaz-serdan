...
export class SchoolCoursesDialogComponent {
  ...
  constructor(
    ...
    @Inject(MAT_DIALOG_DATA) public data: { course: Partial<SchoolCourse>, isNew: boolean }
  ) {
    ...
    this.formData = this.fb.group({
      ...
      courseType: new FormControl(this.data.course.courseType.toString().toLowerCase()),
